<template>
  <div class="list">
    <div class="list-head">
      ...
      <div class="list-head__item t2">拟落地区块</div>
      <div class="list-head__item t3">投资额(万元)</div>
    </div>
    <div class="list-body">
      <template v-if="list.length > 0">
        ...
        >
          ...
          >
            ...
            <div class="item-value t2">{{ item.regionname }}</div>
            <div class="item-time t3">{{ priceFormat(item.totalValue) }}</div>
          </div>
        </vue-seamless>
      </template>
      <template v-else>
